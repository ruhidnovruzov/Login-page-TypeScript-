...
const App: React.FC= () => {
  ...
  return (
    ...
    <div className=" absolute inset-0 bg-cover bg-center bg-[url('/src/assets/bg-img.png')] h-[150vh] w-full">
    </div>
    <div className=" absolute inset-0 bg-black opacity-50 h-[150vh] w-full">
    </div>
